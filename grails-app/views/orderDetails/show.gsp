...
<html>
    ...
    <body>
        ...
        <div id="show-orderDetails" class="content scaffold-show" role="main">
            ...
            <f:display bean="orderDetails" />
            <g:form resource="${this.orderDetails}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.orderDetails}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
