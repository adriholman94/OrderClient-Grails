...
<html>
    ...
    <body>
        <a href="#create-suppliers" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="create-suppliers" class="content scaffold-create" role="main">
            ...
            <g:form resource="${this.suppliers}" method="POST">
                <fieldset class="form">
